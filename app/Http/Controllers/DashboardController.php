...
class DashboardController extends Controller
{
    ...
    public function display()
    {
        ...
        foreach ($years as $year) {
            ...
            $expenses = Expense::where('year_id', $year->id)->get();
            $grouped = $incomes->groupBy('campus_id');
            $grouped_expenses = $expenses->groupBy('campus_id');
            ...
            $yearDataExpense = $campuses->map(function ($campus) use ($grouped_expenses, $months, $year) {
                $records = $grouped_expenses->get($campus->id, collect());
            ...
            $expense_overview[$year->year] = $yearDataExpense->values();
        }
